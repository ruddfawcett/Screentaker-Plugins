...
//
//  Created by Rudd Fawcett on 11/13/13.
//  Copyright (c) 2013 Rudd Fawcett. All rights reserved.
//

#import "RFGlareWhiteEffect.h"

@implementation RFGlareWhiteEffect
...
- (NSImage *)createImageFromScreenshot:(NSImage *)screenshot forDevice:(FKScreenshotEffectDevice)device withOrientation:(FKScreenshotEffectOrientation)orientation {
    ...
    NSImage *iPhone5Portrait = [[NSImage alloc] initWithContentsOfFile:[[NSBundle bundleForClass:[self class]] pathForResource:@"iPhone5_White" ofType:@"png"]];
